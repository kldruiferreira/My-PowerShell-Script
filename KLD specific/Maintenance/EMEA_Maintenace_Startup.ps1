...
#Start Semetric Import Service and Request service on server 1##
Enter-PSSession -Name $WSMServers[0]

Get-Service -Name "SemetricImport" | set-service -StartupType Automatic -Verbose
Get-Service -Name "Request Service" | set-service -StartupType Automatic -verbose

Start-Service -Name "SemetricImport" -Verbose
Start-Service -Name "Request Service" -Verbose

Get-Service -Name "SemetricImport" | Select-Object Name, Status, StartType
Get-Service -Name "Request Service" | Select-Object Name, Status, StartType

Exit-PSSession

#Start Semetric Import Service and Request service on server 2##
...
Start-Service -Name "OIRelease" -Verbose
Start-Service -Name "OIDictionary" -Verbose
Start-Service -Name "OIDdDeduction" -Verbose
Start-Service -Name "Task Service" -Verbose

Get-Service -Name "OI*" | Select-Object Name, Status, StartType
Get-Service -Name "Task Service" | Select-Object Name, Status, StartType
...
Start-Service -Name "Storage Manager Remote Object Service v4.5.2.4" -Verbose
Start-Service -Name "Storage Manager Task Host Service v4.5.2.4" -Verbose
Start-Service -Name "Storage Manager Write Point Monitor Service v4.5.0.24" -Verbose

Get-Service -Name "Storage Manager*" | Select-Object Name, Status, StartType

Exit-PSSession

#start Report Generation Service and DiskSpaceUpdate 
enter-PSSession -Name $WSMServers[0]

Get-Service -Name "Report Generation Service" | set-service -StartupType Automatic -Verbose
Get-Service -Name "DiskSpaceUpdateService" | set-service -StartupType Automatic -verbose

Start-Service -Name "Report Generation Service" -Verbose
Start-Service -Name "DiskSpaceUpdateService" -Verbose

Get-Service -Name "Report Generation Service" | Select-Object Name, Status, StartType
Get-Service -Name "DiskSpaceUpdateService" | Select-Object Name, Status, StartType
...
Exit-PSSession
#CacheServer - work in progress.
# Enter-PSSession -Name $CacheServer

# #load module
# Import-Module -Name DistributedCacheAdministration

# #check cluster
# get-cacheclusterhealth

# #use this command on if cluster not started.
# start-cachecluster
